...
#        tb.send_message(message.chat.id, "Для начала выбери расклад", reply_markup=markup) 
        ...
        if final_state_3 == 10:            # Крест
            photo1 = "rwsun.jpg"
            image_generator_cross(background, photo1, 0, 0, 0)
        elif final_state_3 == 20:          # План
            photo1 = "rwsun.jpg"
            image_generator_plan(background, photo1, 0, 0, 0, 0)
        ...
        if final_state_3 == 10:            # Крест
            photo1 = "rwsun.jpg"
            image_generator_cross(background, photo1, photo1, 0, 0)
        elif final_state_3 == 20:          # План
            photo1 = "rwsun.jpg"
            image_generator_plan(background, photo1, photo1, 0, 0, 0)
        photo = open('out.png', 'rb')      # Вывод карты
        tb.send_photo(message.chat.id, photo)            
        markup = generate_markup(kb)        
        tb.send_message(message.chat.id, "Выберете карту:", 
        ...
        if final_state_3 == 10:            # Крест
            photo1 = "rwsun.jpg"
            image_generator_cross(background, photo1, photo1, photo1, 0)
        elif final_state_3 == 20:          # План
            photo1 = "rwsun.jpg"
            image_generator_plan(background, photo1, photo1, photo1, 0, 0)
        photo = open('out.png', 'rb')      # Вывод карты
        tb.send_photo(message.chat.id, photo)
        markup = generate_markup(kb)          
        tb.send_message(message.chat.id, "Выберете карту:", 
        ...
        if final_state_3 == 10:            # Крест
            photo1 = "rwsun.jpg"
            image_generator_cross(background, photo1, photo1, photo1, photo1)
            tb.send_photo(message.chat.id, photo)
        elif final_state_3 == 20:          # План
            photo1 = "rwsun.jpg"
            image_generator_plan(background, photo1, photo1, photo1, photo1, 0)
            photo = open('out.png', 'rb')      # Вывод карты
            tb.send_photo(message.chat.id, photo)
            kb = read_kb()
            i = -1                         # Поиск выбранной буквы
        ...
        if final_state_3 == 10:            # Крест
            ...
            photo1 = "rwsun.jpg"
            image_generator_plan(background, photo1, photo1, photo1, 
                    photo1, photo1)
        photo = open('out.png', 'rb')      # Вывод карты
        tb.send_photo(message.chat.id, photo)
