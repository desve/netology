...
data.columns = ['возраст 10-15', 'возраст 16-20', 'возраст 21-30', 'возраст 31-40', 'возраст 41-80', 'старше 81', 'Название группы', 'год отсутствует', 'поле отсутствует']
# Переставляем колонки
data_1 = data[['Название группы', 'возраст 10-15', 'возраст 16-20', 'возраст 21-30', 'возраст 31-40', 'возраст 41-80', 'старше 81', 'год отсутствует', 'поле отсутствует']]
