...
# Записываем календарь поездок в файл
    write_to_file(calendar_trips, file_name = 'calendar_trips.txt')
...
# Выход из цикла
    print('Конец работы')
# Записывает конечный список поездок файл
    write_to_file(visits, file_name = 'final_calendar_trips.txt')
...
# Получаем исходный список визитов из файла calendar_trips.txt
read_from_file('calendar_trips.txt')
