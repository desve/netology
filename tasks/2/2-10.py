...
if x22 == x11:
    print("YES! Это ход фепзя вертикале")
elif y2 == y1:
    print("YES! Это ход ферзя по горизонтали")
elif (x22 - x11) == (y2 - y1):
    print("YES! Это ход ферзя по первой диагонали")
elif (x11 - x22) == (y2 - y1):
    print("YES! Это ход ферзя по второй диагонали")
else:
    print("NO! Ферзь так не ходит")
